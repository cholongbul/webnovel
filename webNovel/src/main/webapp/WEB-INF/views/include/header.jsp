				...
				<div class="collapse navbar-collapse" id="navbarsExample07">
					<ul class="navbar-nav me-auto mb-2 mb-lg-0">
						<li class="nav-item dropdown"><a
							class="nav-link dropdown-toggle" href="board/novelBoard" id="dropdown07"
							data-bs-toggle="dropdown" aria-expanded="false">작품</a>
							<ul class="dropdown-menu" aria-labelledby="dropdown07">
								<li><a class="dropdown-item" href="novelBoard">작품 검색</a></li>
								<li><a class="dropdown-item" href="#">작품 태그 검색</a></li>
							</ul></li>
						...
						<li class="nav-item dropdown"><a
							...
							<ul class="dropdown-menu" aria-labelledby="dropdown07">
								<li><a class="dropdown-item" href="#">등장인물 검색</a></li>
								<li><a class="dropdown-item" href="#">등장인물 태그 검색</a></li>
							</ul></li>
						<li class="nav-item"><a class="nav-link" href="#"

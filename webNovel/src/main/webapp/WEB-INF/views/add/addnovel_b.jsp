	...
	<div class="container p-3 border border-info mb-2">
		...
		<div class="tab-content p-3" id="myTabContent">
				...
				<div class="mb-3  col-12 row">
					...
					<div class="col-5">
						<input type="text" class="form-control" id="inputRelation"
							...
							id="emailHelp" class="form-text text-muted">이미 존재하는 작품들
							중에서 관련있는 작품을 선택해주세요.ex)등록작품이 속편이고 본편이 존재할 경우 선택</small>
					</div>
				</div>
			</div>
			<!-- 기본 정보 -->
			...
			<div class="tab-pane fade" id="web" role="tabpanel"
				...
				<div class="mb-3 col-12 row">
					<div class="col-1"></div>
					<div class="col-7 row"><button type="button" class="btn btn-secondary btn-sm p-0 col-1" style="width:23px; margin-left:15px;">+</button>
					<small id="emailHelp" class="form-text text-muted px-2">여러 곳에서
						연재할 경우 추가해주세요. 찾는 연재처가 없다면 <a href=#>등록</a> 해주세요
					</small></div>

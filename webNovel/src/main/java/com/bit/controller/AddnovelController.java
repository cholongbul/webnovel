...
public class AddnovelController {
	...
	private static final Logger logger = LoggerFactory.getLogger(AddnovelController.class);
	...
	public String addwirter(Locale locale, Model model) {
		logger.info("Welcome home! The client locale is {}.", locale);
		...
		return "add/addwriter";
	}
	
	@RequestMapping(value = "/addchar", method = RequestMethod.GET)
	public String addchar(Locale locale, Model model) {
		logger.info("Welcome home! The client locale is {}.", locale);
	...
	public String addtag(Locale locale, Model model) {
		logger.info("Welcome home! The client locale is {}.", locale);
		...
		return "add/addnoveltag";
	}
	
	@RequestMapping(value = "/addchartag", method = RequestMethod.GET)
	public String addchartag(Locale locale, Model model) {
		logger.info("Welcome home! The client locale is {}.", locale);
